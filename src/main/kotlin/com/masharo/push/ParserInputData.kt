...
import com.masharo.push.reader.PushReader
...
class ParserInputData(
    ...
    private fun getPush(systemState: SystemState): Push {
        ...
        if (data.containsKey("text") && data.containsKey("type")) {
            try {
                ...
                throw Exception("com.masharo.push.EasyFactoryPush: ошибка получения параметров пушей")
            }
    ...
    private fun getSystemState(): SystemState {
        ...
        try {
            ...
            throw Exception("com.masharo.push.ParserInputData: ошибка получения данных системы")
        }
